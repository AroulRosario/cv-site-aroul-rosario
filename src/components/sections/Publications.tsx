    ...
    return (
        <section id="publications" className="py-32 relative bg-white">
            <div className="max-w-7xl mx-auto px-6 md:px-12">
                ...
                <div className="mb-40">
                    <div>
                        <div className="flex flex-col md:flex-row md:items-end justify-between mb-20 gap-8 border-b border-slate-100 pb-10">
                            <h2 className="text-5xl md:text-7xl font-display font-medium text-slate-900 tracking-tighter flex items-center gap-6 leading-[0.85]">
                                Published<br />Works
                                <span className="inline-flex items-center justify-center px-4 py-2 rounded-full border border-slate-100 bg-zinc-50 text-[10px] text-slate-400 font-mono translate-y-2 uppercase tracking-widest">
                                    Literature
                                </span>
                            </h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {cvData.books.map((book, index) => (
                            <div key={index}>
                                <div className="group flex flex-col justify-between h-full p-12 border border-slate-100 bg-zinc-50/50 hover:bg-white hover:border-zinc-300 hover:shadow-2xl hover:shadow-zinc-200/50 transition-all duration-500 rounded-[2.5rem]">
                                    <div className="flex justify-between items-start mb-16">
                                        <div className="w-14 h-14 rounded-2xl bg-white border border-slate-100 flex items-center justify-center group-hover:bg-zinc-950 group-hover:border-zinc-950 transition-all duration-500">
                                    ...
                                    <h3 className="text-3xl font-display font-medium text-slate-900 leading-tight">
                                        {book.title}
                                    </h3>
                                </div>
                            </div>
